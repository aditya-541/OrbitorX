      ...
      <div className="max-w-3xl mx-auto">
        ...
        {submitted ? (
          <FadeIn className="text-center py-16 border border-neon/30 neon-glow">
            <p className="font-pixel text-neon text-sm">Transmission Received.</p>
            <p className="font-mono-custom text-white/40 text-xs mt-4 tracking-widest">
          ...
          <FadeIn>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="contact-name" className="font-mono-custom text-neon text-xs tracking-widest">
                  NAME //
                </label>
                <input
                  id="contact-name"
                  ...
                  className="neon-input font-sans text-sm px-4 py-3 w-full cursor-blink"
                  autoComplete="name"
                />
              </div>
              ...
              {/* Email */}
              <div className="flex flex-col gap-2">
                <label htmlFor="contact-email" className="font-mono-custom text-neon text-xs tracking-widest">
                  EMAIL //
                </label>
                <input
                  id="contact-email"
              ...
              {/* Message */}
              <div className="flex flex-col gap-2">
                <label htmlFor="contact-message" className="font-mono-custom text-neon text-xs tracking-widest">
                  MESSAGE //
                </label>
                <textarea
                  id="contact-message"
              ...
              <div className="flex items-center justify-between gap-4 flex-wrap">
                <button
                  id="contact-submit"
                  type="submit"
                  className="btn-neon font-pixel text-xs px-8 py-4 tracking-widest animate-pulse-neon"
                >
                  Launch →
                </button>
                <p className="font-mono-custom text-white/30 text-[10px] tracking-widest">
                  No spam. Only signal.
                </p>
              </div>
            </form>
        ...
        {/* Social links */}
        <FadeIn className="mt-16 flex items-center justify-center gap-6">
          {SOCIAL_LINKS.map(({ id, label, href, icon }) => (
            <a
              ...
              aria-label={label}
              className="text-white/40 hover:text-neon transition-colors duration-300 p-2 border border-white/10 hover:border-neon/50 hover:shadow-neon"
            >
              {icon}
            </a>
          ))}
